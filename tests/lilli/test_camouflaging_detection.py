"""AUTIST-13 camouflaging detector.

The detector observes the user's SURFACE formality trajectory. When an
over-formal sliding-5 weekly trajectory is confirmed, the system adjusts OUR
register — never pushes the user to change. Masking modeling is forbidden
(Cook 2021 / Raymaker 2020).
"""
