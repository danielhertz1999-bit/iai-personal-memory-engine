"""Tests for LEARN-01 Bayesian profile + LEARN-06 identity refinement.

D-20 weighted-ensemble posterior:
...
def test_bayesian_update_int_range():
    ...
    pytest.skip("no int_range knob in registry (all knobs are float/dict/enum/bool)")
